const timelineData = [
    ...
    },
    {
        ...
        año: "20 ABY",
        imagenes: [
            "assets/portadas/juegos/zero-company.webp",
        ],
        titulo: 'Juego "Star Wars: Zero Company"',
        eventos: [{ tiempo: 'Sucede hacia el final de la Guerra de los Clones', descripcion: '- Acompaña a este escuadrón de élite en sus misiones tácticas durante los momentos más críticos del conflicto.' }]
    },
    {
        eraId: "era-republica",
        categoria: "animated",
